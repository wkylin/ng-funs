...
有任何疑问，欢迎提交 [issue](https://github.com/wkylin/ng-funs/issues)，
或者直接修改提交 [PR](https://github.com/wkylin/ng-funs/pulls)!
...
提交后就可以在 [ng-funs](https://github.com/wkylin/ng-funs/pulls) 创建 Pull Request 了。
